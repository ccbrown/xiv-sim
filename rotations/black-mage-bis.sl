...
if (AuraCount(self, "thundercloud", self) and (AuraTimeRemaining(self, "umbral-ice", self) > 4.5 or AuraTimeRemaining(self, "astral-fire", self) > 4.5))
	use "thunder-iii";

if (AuraTimeRemaining(target, "thunder-dot", self) < 10.0 and (AuraCount(self, "umbral-ice", self) and MP(self) >= 319))
	use "thunder-ii";

if (AuraTimeRemaining(self, "astral-fire", self) > 4.5 and MP(self) >= 319 * 2 + 80)
	use "fire";
